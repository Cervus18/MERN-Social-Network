...
import { GET_PROFILE, PROFILE_ERROR, UPDATE_PROFILE, ACCOUNT_DELETED, CLEAR_PROFILE, GET_PROFILES, FOLLOW_UNFOLLOW_USER, GET_FOLLOWINGS } from './types'
...
export const getProfiles = (query) => async dispatch => {
    ...
    try {
        const res = await axios.get(`/api/profile/search/${query}`)
